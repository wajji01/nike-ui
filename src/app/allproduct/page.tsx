...
export default function Allproduct() {
  ...
  return (
    <>
      <Navber />
      <div className="grid lg:grid-flow-col md:grid-cols-12 gap-6 p-5">
        {/* Sidebar for filters */}
        <div className="col-span-12 lg:col-span-4 p-5 border">
          <h1 className="font-bold text-2xl">New(500)</h1>
          <div>
            <ul className="text-xl font-bold space-y-5 mt-5">
              <li>Shoes</li>
              <li>Sports Bras</li>
              <li>Tops & T-Shirts</li>
              <li>Hoodies & Sweatshirts</li>
        ...
        <div className="col-span-12 lg:col-span-8 border p-5">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-6 mt-5">
            {BestOfAirMax.map((card) => (
              <div key={card.id} className="rounded-lg overflow-hidden bg-white">
                <div>
                  <Image
